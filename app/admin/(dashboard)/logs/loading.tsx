        ...
        <section className="relative flex min-h-0 flex-1 flex-col overflow-hidden rounded-md border border-border">
          <div className="min-h-0 flex-1 overflow-y-auto">
            <div className="divide-y divide-border">
              <div className="sticky top-0 z-10 grid grid-cols-[220px_180px_280px_minmax(220px,1fr)_48px] items-center gap-4 bg-background px-2 py-3">
              ...
              {Array.from({ length: 8 }).map((_, i) => (
                <div
                  key={i}
                  className="grid h-12 grid-cols-[220px_180px_280px_minmax(220px,1fr)_48px] items-center gap-4 px-2"
                >
